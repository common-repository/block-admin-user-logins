=== Block user logins ===
Contributors: acsnaterse
Tags: email, wp_mail
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=L9TLPZWMVD7H6
...
Blocks every login attempt for the "admin" user, or every user, but the users in your install.
